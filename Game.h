...
#define DEF_GAMEMODE_ONLOGIN				7
#define DEF_GAMEMODE_ONQUERYFORCELOGIN		8
#define DEF_GAMEMODE_ONSELECTCHARACTER		9
#define DEF_GAMEMODE_ONCREATENEWCHARACTER	10
#define DEF_GAMEMODE_ONWAITINGRESPONSE		11
#define DEF_GAMEMODE_ONQUERYDELETECHARACTER 12
#define DEF_GAMEMODE_ONLOGRESMSG			13
#define DEF_GAMEMODE_ONCHANGEPASSWORD		14
#define DEF_GAMEMODE_ONVERSIONNOTMATCH		15
#define DEF_GAMEMODE_ONINTRODUCTION			16
#define DEF_GAMEMODE_ONSELECTSERVER			17
#define DEF_GAMEMODE_ONINPUTKEYCODE			18
...
public:
	...
	BOOL _bCheckDlgBoxClick(short msX, short msY, int cRB);
	...
	void DlgBoxClick_IconPannel(short msX, short msY, int cRB);
...
//	int m_iAccountStatus;
	...
	void DlgBoxClick_OnlineUsers(int msX, int msY);
